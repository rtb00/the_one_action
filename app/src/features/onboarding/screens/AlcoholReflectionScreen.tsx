...
export default function AlcoholReflectionScreen() {
  const navigate = useNavigate();
  const { alcohol } = useOnboardingStore();
  const motivation = alcohol?.motivation || 0;
        ...
        <div className="max-w-md w-full space-y-12">
          <GlassCard className="space-y-10">
            ...
            {!isEnabled ? (
              ...
              <button
                onClick={() => navigate('/onboarding/alcohol/info')}
                className="
                  w-full
                  py-4
                  px-6
